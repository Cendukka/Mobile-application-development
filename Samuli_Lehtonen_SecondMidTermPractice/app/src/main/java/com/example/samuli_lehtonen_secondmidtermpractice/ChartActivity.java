...
public class ChartActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            //compute the width of vitamin C consumption and draw with magenta
            if(checkedStates[2] == 1) {
            ...
            //compute the width of vitamin D consumption and draw with green
            if(checkedStates[3] == 1) {
